...
aseprite -b sprite/**/*.{png,ase} sprite/*.{png,ase} --sheet src/public/asset/spritesheet/sheet.png --data src/public/asset/spritesheet/data.json --filename-format '{title}-{frame1}'
